...
- [Live Demo Link](https://live-news-codepantha.vercel.app/)
...
```sh
  cd my-folder
  git clone https://github.com/codepantha/live-news.git
```
...
Feel free to check the [issues page](https://github.com/codepantha/live-news/issues).
